...
`pip install git+https://github.com/bhavberi/whisperx.git`

If already installed, update package to most recent commit

`pip install git+https://github.com/bhavberi/whisperx.git --upgrade`

If wishing to modify this package, clone and install in editable mode:
```
$ git clone https://github.com/bhavberi/whisperX.git
$ cd whisperX
$ pip install -e .
```
